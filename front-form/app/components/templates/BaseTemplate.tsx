    ...
    return (
        <div className="flex flex-col items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-black">
            <div className="w-full">
                <div className='flex lg:flex-row flex-col mx-auto lg:mx-0 items-center justify-between gap-2 lg:w-[31.25rem]'>
                    {!isPathRoot && (
                    ...
                    <h1 className='text-white text-3xl text-center lg:text-left'>{titlePage}</h1>
                </div>
            </div>
